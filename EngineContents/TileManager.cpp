...
ATileManager::ATileManager()
{
	...
	GroundTileMap->SetTileSetting(ETileMapType::Rect, "img_tile_plain.png", { 56.f, 56.f }, { 56.f, 56.f }, { 0.0f, 0.0f });

	CroppatchTile = CreateDefaultSubObject<UTileMapRenderer>();
	CroppatchTile->SetupAttachment(RootComponent);
	CroppatchTile->SetTileSetting(ETileMapType::Rect, "img_tile_plain.png", { 56.f, 56.f }, { 56.f, 56.f }, { 0.0f, 0.0f });
}
